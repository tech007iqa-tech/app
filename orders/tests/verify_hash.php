...
for ($length = 25; $length <= 125; $length++) {
    ...
    // So cell_len goes from 5 to 25.
}

// Let's loop directly on cell_len from 5 to 25.
for ($cell_len = 5; $cell_len <= 25; $cell_len++) {
    $grids = [
...
echo "No matches found across all cell lengths." . PHP_EOL;
?>
